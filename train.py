...
#     train_x = sorted(glob(os.path.join(path,r"C:\Users\ramta\Desktop\DM_cloth\DM_cloth\images", "*.jpg")))
#     train_y = sorted(glob(os.path.join(path,r"C:\Users\ramta\Desktop\DM_cloth\DM_cloth\masks", "*.png")))
#
#     valid_x = sorted(glob(os.path.join(path, "images", "*.jpg")))
#     valid_y = sorted(glob(os.path.join(path, "masks", "*.png")))
#
